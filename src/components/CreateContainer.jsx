...
const CreateContainer = () => {
  ...
  const [alterStatus, setAlertStatus] = useState("danger");
          ...
          >
            ...
            {categories &&
              categories.map((item) => (
                <option
                  key={item.id}
                  className="text-base border-0 outline-none bg-white capitalize text-headingColor"
            ...
            <>
              {!imageAsset ? (
                ...
                <>
                  ...
                  text-xl outline-none cursor-pointer hover:shadow-md duration-500 transition-all ease-in-out"
                      onClick={deleteImage}
                    >
